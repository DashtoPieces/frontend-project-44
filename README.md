...
[![Quality Gate Status](https://sonarcloud.io/api/project_badges/measure?project=DashtoPieces_frontend-project-44&metric=alert_status)](https://sonarcloud.io/summary/new_code?id=DashtoPieces_frontend-project-44)

## Описание проекта

```
5 различных математических задачек для разминки мозга
```
